...
Im Computerspiel Spore \cite{Spore} werden sogar zur Laufzeit Animationen für Figuren erzeugt, deren Aufbau vorher noch nicht bekannt war. Dazu werden vorher abstrakte Animationen, unabhängig vom Aufbau der speziellen Figur, erzeugt. Diese werden dann zur Laufzeit auf die konkreten Figuren angewandt. \cite{sporeanim}
...
Die "`Nachkommen"' bilden nun eine neue Population, die wiederum anhand der Fitnessfunktion bewertet wird und es startet eine neue Iteration.
...
In der Masterarbeit \cite{JonHudson} werden 3D-Modelle von Lebewesen und ein passendes Rig mit Hilfe von genetischen Algorithmen generiert. Das Augenmerk liegt dort aber, im Gegensatz zu dieser Arbeit, nicht auf realistischen Tieren oder realistischen Skeletten.
