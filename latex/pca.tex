...
\end{itemize}
 ...
 Nun zum Gewicht. Das Gewicht der Eingabedaten ist nicht normalverteilt (siehe Abbildung \ref{gnuplot_weight}), aber auf einer logarithmischen Skala schon (siehe Abbildung \ref{gnuplot_log_weight}). \todo{QQ Diagramme verstehen und programmieren}
 \todo{Gewichtplots nach Größe sortieren?}
