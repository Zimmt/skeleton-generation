%------------
%------------
\chapter{Analyse von Skeletten mit Hilfe von PCA}
\label{chapter:pca}

\todo{umbenennen}
 
 PCA wird verwendet um Position und Krümmung der Wirbelsäule bei Wirbeltieren zu untersuchen. Die Datenpunkte, die durch PCA untersucht werden sollen, sind also Skelette von Wirbeltieren.
 ...
 \todo{welche weiteren Merkmale könnte man sich überlegen, warum waren sie nicht sinnvoll? future work?}
 \todo{erklären warum Winkel an Extremitäten nicht erhoben}
...
%  \end{itemize}
 ...
 \todo{Werte der Mittelwertvisualisierung angeben wenn zuletzt aktualisiert, damit Bild nicht so groß sein muss; und Rand abschneiden}
...
\begin{figure}
 ...
 \todo{Anpassung der Stile der Plots}
...
\begin{figure}
 ...
 %-------------------------------------------------
 \section{Bedingte Verteilung der Eingabedaten}
