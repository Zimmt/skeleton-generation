...
\end{itemize}
 ...
 Die Diagramm zeigen, dass die Dimensionen alle mehr oder weniger normalverteilt sind (siehe Abbildungen \ref{qqdiagram_examples} und  im Anhang). \todo{Rest in Anhang} 
...
\begin{figure}
 ...
 Im Gegensatz dazu bildet die Aufteilung nach der Anzahl der Beine wiederum Cluster (siehe Abbildungen \ref{input_data_legs} und \ref{projection_legs}).
 
 Skaliert man das Flügel und Beine um Faktor $1000$ kleiner, so verschwinden die Cluster (siehe Abbildung ...) \todo{Skalierung Beschreiben (auch schon in den vorherigen Abschnitten) und Abbildungen einfügen}
