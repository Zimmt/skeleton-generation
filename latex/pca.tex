...
\chapter{PCA}
 ...
 \todo{Warum PCA und nicht zB apriori Algorithmus?}
 Position und Krümmung der Wirbelsäule charakteristisch \todo{Handbuch der Anatomie für Künstler als Quelle?}

 \emph{Primary Component Analysis} (PCA) wird mit dem Ziel angewendet herauszufinden was die Dimensionen sind, in denen sich Skelette am meisten unterscheiden. \todo{PCA Quelle}
 ...
 \todo{Abschnitt über konkrete Beispiele. Warum diese? Einigermaßen sinnvoll verteilt?}
 
 \todo{Warum wurden ausgerechnet diese Daten erhoben? (Position der Wirbelsäule um Balanceberechnungen zu vermeiden)}
 ...
 \begin{itemize}
  ...
  \item Gewicht in kg - grob geschätztes Gewicht eines ausgewachsenen Exemplars dieser Art. Das ist oft ein Maximalwert, da oft nur dieser in Artikeln über Tiere angegeben wird. Der größte Wert, der hier möglich ist, beträgt $120$ Tonnen. Das ist das Gewicht des schwersten Wirbeltiers, eines Blauwals. \todo{logarithmisch?}
 \end{itemize}

 Alle erfassten Dimensionen werden vor der Weiterverarbeitung durch die PCA auf das Intervall $[0, 1]$ skaliert, so dass jede Dimension den gleichen Einfluss auf das Ergebnis hat. \todo{Auswirkungen der Skalierung erklären (ändert Gewichtung; Gewichtung nach größe im Bild / nach Auswirkung auf Gesamteindruck des Skeletts)}
 ...
 %- - - - - - - - - - - - - - - - - -
 \subsection{Analyse der Eingabedaten}
