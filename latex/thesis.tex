...
\begin{figure}
 ...
 \caption*{Beispiel für ein Skelett, dass mit dem hier vorgestellten Algorithmus generiert werden kann. Als Hintergrund wurde \cite{background} verwendet.}
\end{figure}
\blankpage
...
\include{basics}
\include{pca}
\include{skeleton_generation}
\include{additional_features}
