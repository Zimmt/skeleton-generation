...
logos/
------
In diesem Verzeichnis befinden das KIT-und das SDQ-Logo als PDF und EPS.
Die Logos können durch eigene ersetzt werden, falls die Abschlussarbeit
an einem anderen Lehrstuhl angefertigt wird.
...
English Version
===============
This is a template for student's theses at the chair of Software Design and
Quality (SDQ) at the Institute of Program Structures and Data Organization (IPD)
...
logos/
------
This directory contains the KIT and SDQ logos in PDF and EPS.
If the thesis is written at another institute, you can replace the SDQ
logo by a custom one.
