...
Zusätzlich wird nicht in jedem Schritt jeder Freiheitsgrad jedes Gelenks verändert. Für jeden Freiheitsgrad wird eine Wahrscheinlichkeit (kleiner als eins) festgelegt, dass dieser ausgewählt wird. Dadruch können bestimmte Richtungen oder Gelenke priorisiert werden um ein besseres Ergebnis zu erzielen. \todo{Was sind die guten Einstellungen?}
Außerdem gibt es eine gewisse Fehlerwahrscheinlichkeit, die ein Gelenk in die entgegengesetzte Richtung dreht, als die, die eigentlich "`richtig"' wäre. Dadurch soll verhindert werden, dass in bestimmten Situationen immer die gleichen "`Fehler"' gemacht werden. \todo{bringt das was?}
