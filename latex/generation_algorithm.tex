...
Es ist auch möglich kleine Fortsätze (wie \zb diejenigen von Wirbeln) über den Würfel hinaus stehen zu lassen. Das macht unter Umständen die Positionierung einfacher. Auch die Skalierung der Gelenkfläche auf die gesamte Kantenlänge des Würfels ist praktisch, da dann einfach festzustellen ist wie groß der Kindknochen skaliert werden muss, damit die beiden am Gelenk zusammenpassen. Aufpassen muss man allerdings, dass die Knochen nicht komisch verzerrt werden. Es ist \zb bei Beinknochen hilfreich, wenn die x- und die z-Richtung gleich skaliert werden, um die Originalverhältnisse zu bekommen. \todo{ausformulieren, Beispiele}
...
Da es bei der menschliche Hüfte aber Probeleme mit den Lizenzrechten gab, wurde dann eine frei verfügbare Hüfte eines Pferdes verwendet. Hier ist die Wirbelsäule allerdings nicht mit der Hüfte verwachsen, was die Positionierung der Hüfte und auch der Wirbel einfacher macht.
